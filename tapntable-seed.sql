...
2),
('Baby Duck',
'Baby spinach, applewood-smoked bacon, carmelized maple walnuts, dried cranberries and hard-boiled eggs finished w/ our own cherry viaigrette',
7.99,
3,
2),
('The Angry Angus',
...
1),
('The French DIP',
'Hand-sliced juicy roast beef piled high on a toasted roll w/ home-made french onion soupd for DIP-ing',
8.99,
4,
1),
('The Cape Codder',
'Only the freshest local haddock, beer-battered and traditionally prepared served golden brown on a toasted Kaiser roll w/ fresh field greens, tomato and a side of our hous-made tartar sauce',
9.99,
4,
1),
('The Drunken Pig',
...
'Six hard-boiled egg halves filles w/ a lightly seasoned eg yoke and fresh lobster center topped with caviar',
10.99,
8,
2),
('Shrimp Cocktail',
'w/ our zesty home-made cocktai or spicy remoulade sauce',
1.99,
8,
2),
('Duck Wings',
