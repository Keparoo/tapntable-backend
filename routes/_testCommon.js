...
const u1Token = createToken({ username: 'u1', role: 'trainee' });
// Create token with most common role: server
const u2Token = createToken({ username: 'u2', role: 'server' });
// Create token with access role: manager
const adminToken = createToken({ username: 'admin', role: 'manager' });
